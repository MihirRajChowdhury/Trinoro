...
export default function ChatPopup() {
    ...
    // if (!session) return null; // Logic moved to render
                ...
                <div className="fixed bottom-6 right-6 w-[350px] sm:w-[400px] h-[500px] bg-white/10 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/20 overflow-hidden flex flex-col z-50 animate-in slide-in-from-bottom-10 fade-in duration-300">
                    ...
                    {!session ? (
                        <div className="flex-1 flex flex-col items-center justify-center p-6 text-center space-y-6">
                            ...
                            <div className="space-y-2">
                                <h4 className="text-xl font-bold text-white">Unlock AI Insights</h4>
                                <p className="text-indigo-100 text-sm leading-relaxed">
                                    Sign in to experience personalized meditation sessions generated by AI just for you.
                                </p>
                            </div>
                            <button
                                onClick={() => signIn("google")}
                                className="w-full py-3 rounded-xl bg-white text-indigo-600 font-semibold shadow-lg hover:bg-gray-50 transition-colors"
                            >
                                Sign in with Google
                            </button>
                        </div>
